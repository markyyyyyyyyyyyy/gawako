...
$branch =  $_POST['branch'];
$sql = "INSERT INTO test (branch, contact_number, date, time) VALUES ('$branch','$contact_number', '$userdate', '$usertime' )";
...
<form action="confirmation.php" class="row g-3" method="post">
<div class="container">
<style>
.regis-form{
    padding: 15px;
