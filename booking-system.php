...
$branch =  $_POST['branch'];
$sql = "INSERT INTO appointments (branch, contact_number, date, time) VALUES ('$branch','$contact_number', '$userdate', '$usertime' )";

// echo '<script>window.location.href = "confirmation.php"</script>';

$sql = "INSERT INTO appointments ( contact_number, date, time, branch ) VALUES ('$contact_number', '$userdate', '$usertime', '$branch')";
...
<div class="regis-form">
  ...
  <div class="col-12">
    ...
    <input type="hidden"  name="editnumber"  name="editnumber" value="contact_number">
  </div>
  <div class="col-12">
  <label for="date">Preferred date</label>
            <input type="date" id="date" name="userdate" required name="date" value="">
            <input type="hidden"  name="editdate"  name="editdate" value=""><br><br>
    
  </div>
  <div class="col-md-6">
  <label for="time">Preferred time:</label>
            <input type="time" id="time" name="usertime" required name="time"><br><br>
            <input type="hidden"  value="" name="editdate"><br><br>
  </div>
  <div class="col-md-6">
